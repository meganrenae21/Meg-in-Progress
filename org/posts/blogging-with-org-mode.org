...
<div id="navlink-3"><a href="../categories.org">categories</a></div>
</div>
#+END_EXPORT
...
Now that I have built the framework I need for this to work correctly, there are only a couple of things left before going live. The obvious one is to create an [[../about.org][About Page]], which is self-explanatory, along with a [[../work.org][Work Page]] to show off exactly what I've done in the past (though it doesn't feel like I have much...yet), and a [[../categories.org][Categories Page]] to link to all of the individual category indices.
